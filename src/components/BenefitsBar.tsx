        ...
        <>
            <section className="flex flex-col items-center justify-center gap-10 px-4 md:flex-row flex-wrap bg-divisorLightBeige h-auto md:justify-around py-24">
                <div className="flex flex-row gap-4">
                    <img src="/assets/icons/trophy 1.svg" alt="Trophy Icon" />
                ...
                <div className="flex flex-row gap-4">
                    <img src="/assets/icons/guarantee.svg" alt="Guarantee Icon" />
                    <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-row gap-4">
                    <img src="/assets/icons/shipping.svg" alt="Free Shipping Icon" />
                    <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-row gap-4">
                    <img src="/assets/icons/customer-support.svg" alt="Customer Support Icon" />
                    <div className="flex flex-col gap-2">
